...
Having been to Lodond frequently for 3 years and settling there I have witnessed the overall change in trend of the demand for the Tfl bikes. I initially, lived the most drastic change (considered at the time) from tje blue Barclays to the red Santander. More recently, I had the feeling that there were less bikes at the stations, so when I had the opportunity to analyze the actual database I was delighted, and here below is my analysis.
...
plot_weekly_difference#We define weekly_diff_percent as Y for logical statements
diff_percent <- weekly_difference$weekly_diff_percent
